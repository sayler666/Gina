...
object IronSkyColors {
    private val light_primary = Color(0xff0059a8)
    private val light_onPrimary = Color(0xffffffff)
    private val light_primaryContainer = Color(0xffd0e8ff)
    private val light_onPrimaryContainer = Color(0xff001b3d)
    private val light_secondary = Color(0xff006b5f)
    private val light_onSecondary = Color(0xffffffff)
    private val light_secondaryContainer = Color(0xff7ff3e0)
    private val light_onSecondaryContainer = Color(0xff00201c)
    ...
    private val light_inversePrimary = Color(0xff79c0ff)
    private val light_surfaceTint = Color(0xff0059a8)
    private val light_outlineVariant = Color(0xffcac4d0)
    private val light_scrim = Color(0xff000000)

    private val dark_primary = Color(0xff79c0ff)
    private val dark_onPrimary = Color(0xff002147)
    private val dark_primaryContainer = Color(0xff003570)
    private val dark_onPrimaryContainer = Color(0xffd0e8ff)
    private val dark_secondary = Color(0xff62d6c4)
    private val dark_onSecondary = Color(0xff00332d)
    private val dark_secondaryContainer = Color(0xff004d45)
    private val dark_onSecondaryContainer = Color(0xff7ff3e0)
    private val dark_tertiary = Color(0xffa8c4fa)
    private val dark_onTertiary = Color(0xff1c2f5c)
    private val dark_tertiaryContainer = Color(0xff334572)
    ...
    private val dark_background = Color(0xff0f111a)
    ...
    private val dark_inversePrimary = Color(0xff0059a8)
    private val dark_surfaceTint = Color(0xff79c0ff)
