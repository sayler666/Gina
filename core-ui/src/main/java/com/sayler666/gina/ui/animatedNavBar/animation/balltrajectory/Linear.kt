...
import androidx.compose.ui.unit.dp
import com.sayler666.gina.ui.animatedNavBar.ballSize
import com.sayler666.gina.ui.toPxf
import kotlin.math.PI
import kotlin.math.sin

/**
 *Describing linear ball animation
 *@param [animationSpec] animation spec of linear ball trajectory
...
class Linear(
    ...
    override fun animateAsState(targetOffset: Offset): State<BallAnimInfo> {
        ...
        LaunchedEffect(targetOffset) {
            var height = if (to != targetOffset) maxHeightPx else -20f
        ...
        return produceState(
            ...
            if (pos[0] == Float.MAX_VALUE) {
                ...
                this.value = this.value.copy(
                    ...
                    scaleY = calculateNewScale(fraction.value)
                )
            }
        }
    }
    ...
    private fun calculateNewScale(
        fraction: Float,
    ): Float = -sin(PI * fraction).toFloat() * 0.3f + 1
